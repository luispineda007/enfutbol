...
class File extends Base
{
    ...
    protected static $mimeTypes = array(
        ...
        'application/vnd.oasis.opendocument.img'                                  => 'odi',
        'application/vnd.oasis.opendocument.img-template'                         => 'oti',
        ...
        'img/gif'                                                                 => 'gif',
        'img/ief'                                                                 => 'ief',
        'img/jpeg'                                                                => array('jpeg', 'jpg', 'jpe'),
        'img/ktx'                                                                 => 'ktx',
        'img/png'                                                                 => 'png',
        'img/prs.btif'                                                            => 'btif',
        'img/sgi'                                                                 => 'sgi',
        'img/svg+xml'                                                             => array('svg', 'svgz'),
        'img/tiff'                                                                => array('tiff', 'tif'),
        'img/vnd.adobe.photoshop'                                                 => 'psd',
        'img/vnd.dece.graphic'                                                    => array('uvi', 'uvvi', 'uvg', 'uvvg'),
        'img/vnd.dvb.subtitle'                                                    => 'sub',
        'img/vnd.djvu'                                                            => array('djvu', 'djv'),
        'img/vnd.dwg'                                                             => 'dwg',
        'img/vnd.dxf'                                                             => 'dxf',
        'img/vnd.fastbidsheet'                                                    => 'fbs',
        'img/vnd.fpx'                                                             => 'fpx',
        'img/vnd.fst'                                                             => 'fst',
        'img/vnd.fujixerox.edmics-mmr'                                            => 'mmr',
        'img/vnd.fujixerox.edmics-rlc'                                            => 'rlc',
        'img/vnd.ms-modi'                                                         => 'mdi',
        'img/vnd.ms-photo'                                                        => 'wdp',
        'img/vnd.net-fpx'                                                         => 'npx',
        'img/vnd.wap.wbmp'                                                        => 'wbmp',
        'img/vnd.xiff'                                                            => 'xif',
        'img/webp'                                                                => 'webp',
        'img/x-3ds'                                                               => '3ds',
        'img/x-cmu-raster'                                                        => 'ras',
        'img/x-cmx'                                                               => 'cmx',
        'img/x-freehand'                                                          => array('fh', 'fhc', 'fh4', 'fh5', 'fh7'),
        'img/x-icon'                                                              => 'ico',
        'img/x-mrsid-img'                                                       => 'sid',
        'img/x-pcx'                                                               => 'pcx',
        'img/x-pict'                                                              => array('pic', 'pct'),
        'img/x-portable-anymap'                                                   => 'pnm',
        'img/x-portable-bitmap'                                                   => 'pbm',
        'img/x-portable-graymap'                                                  => 'pgm',
        'img/x-portable-pixmap'                                                   => 'ppm',
        'img/x-rgb'                                                               => 'rgb',
        'img/x-tga'                                                               => 'tga',
        'img/x-xbitmap'                                                           => 'xbm',
        'img/x-xpixmap'                                                           => 'xpm',
        'img/x-xwindowdump'                                                       => 'xwd',
