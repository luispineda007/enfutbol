...
{!!Form::open(['id'=>'formPlanilla', 'autocomplete'=>'off', 'class'=>'form-horizontal'])!!}
...
<div class="col-xs-12" style="margin-top: 15px;">
    ...
    @if(count($plantilla->getJugadores) < 15)
        ...
        <div class="form-group" style="margin-bottom: 20px">
            ...
            <div class="col-sm-2">
                <i class="fa fa-search fa-2x" id="iconoIntegrante"></i>
            </div>
        </div>
        {!!Form::close()!!}
    @endif
    ...
    <table id="participantes" class="table table-bordered table-hover">
        <thead>
        <tr>
        ...
        @foreach($plantilla->getJugadores as $integrante)
            ...
            <tr class="fila">
                ...
                <td class="text-center" data-integrante="{{$integrante->id}}">
                    <i class="fa fa-times-circle-o fa-2x eliminar pointer" data-toggle='tooltip' data-popout='true' data-placement='top' title="Eliminar"></i>
                </td>
            </tr>
        @endforeach
        </tbody>
